...
wind_simulation_fan_channel::wind_simulation_fan_channel(
    common::channel_type channel_type,
    std::shared_ptr<common::controller_ctx> ctx)
    : channel::channel(common::subsystem::main, channel_type,
                       ctx)
{}

//---------------------------------------------------------------------------------------------------------------------

void wind_simulation_fan_channel::channel_activation_cb(
    common::task_context task_ctx, wind_simulation_fan_channel *_this)
{
    common::log(common::log_level::log_level_debug,
                "[wind_simulation_fan_channel::channel_activation_cb]");
    _this->activate();
}

//---------------------------------------------------------------------------------------------------------------------

void wind_simulation_fan_channel::channel_deactivation_cb(
    common::task_context task_ctx, wind_simulation_fan_channel *_this)
{
    if (task_ctx.id != _this->latest_deactivation_task_id_) {
        common::log(common::log_level::log_level_debug,
                    "[wind_simulation_fan_channel::channel_deactivation_cb] "
                    "ignore outdated "
                    "timer callback");
        return;
    }
...
void wind_simulation_fan_channel::hourly_tick()
{
    common::log(common::log_level::log_level_debug,
                "[wind_simulation_fan_channel::hourly_tick]");
...
void wind_simulation_fan_channel::activate()
{
    /* Invocation context:
    ...
    common::log(common::log_level::log_level_debug,
                "[wind_simulation_fan_channel::activate]");
    ...
    if (indexes.size() == 1) {
        ...
        throw std::runtime_error(
            "[wind_simulation_fan_channel::activate] critical error");
    }
...
void wind_simulation_fan_channel::deactivate()
{
    /* Invocation context:
    ...
    common::log(common::log_level::log_level_debug,
                "[wind_simulation_fan_channel::deactivate]");
    ...
    if (indexes.size() == 1) {
        ...
        throw std::runtime_error(
            "[wind_simulation_fan_channel::deactivate] critical error");
    }
}
